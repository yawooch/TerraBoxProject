...
CREATE TABLE "MOVIE" (
    ...
    "MV_KOR_NAME"   VARCHAR2(100)       NOT NULL,
    "MV_ENG_NAME"   VARCHAR2(100)       NULL,
    "MV_POSTER"     VARCHAR2(50)        NOT NULL,
    "MV_INTRO_CONT" VARCHAR2(100)       NULL,
    "MV_TYPE"       VARCHAR2(200)       NULL,
    "MV_DIRECTOR"   VARCHAR2(30)        NULL,
    "MV_GENRE"      VARCHAR2(20)        NULL,
    "MV_GRADE"      CHAR(4)             NULL,
...
CREATE TABLE "CINEMA" (
    ...
    "CINEMA_AREA"       VARCHAR2(20)        NOT NULL,
...
CREATE TABLE "FAQ" (
    ...
    "FAQ_TITLE"     VARCHAR2(40)        NULL,
    "FAQ_CONTENT"   VARCHAR2(200)       NULL,
...
CREATE TABLE "QUESTION" (
    "QUEST_NO"          VARCHAR2(20)        NOT NULL,
    "QUEST_TITLE"       VARCHAR2(40)        NOT NULL,
    "QUEST_CONTENT"     VARCHAR2(200)       NULL,
    "QUEST_PASS_NO"     VARCHAR2(10)        NOT NULL,
    "QUEST_PHONE"       VARCHAR2(13)        NULL,
    "QUEST_NAME"        VARCHAR2(10)        NULL,
    "QUEST_DIVISION"    VARCHAR2(30)        NULL,
    "QUEST_EMAIL"       VARCHAR2(20)        NULL,
    "QUEST_TYPE"        VARCHAR2(20)        NULL,
    "PICTR_FILE"        VARCHAR2(40)        NULL,
    "VISIT_NUM"         NUMBER(5)           NULL,
    "RENTAL_DATE"       VARCHAR(10)         NULL,
    "RENTAL_TIME"       VARCHAR2(8)         NULL,
    "MEMBER_ID"         VARCHAR2(30)        NOT NULL,
    "LOST_CINEMA_ID"    VARCHAR2(10)        NOT NULL,
    "CINEMA_ID"         VARCHAR2(10)        NOT NULL,
...
ALTER TABLE "MOVIE_VIDEO" ADD CONSTRAINT "FK_MOVIE_TO_MOVIE_VIDEO_1"    FOREIGN KEY (     "MOVIE_NO"   ) REFERENCES "MOVIE"      (     "MOVIE_NO" );
ALTER TABLE "MOVIE_STEAL" ADD CONSTRAINT "FK_MOVIE_TO_MOVIE_STEAL_1"    FOREIGN KEY (     "MOVIE_NO"   ) REFERENCES "MOVIE"      (     "MOVIE_NO" );
ALTER TABLE "TICKET"      ADD CONSTRAINT "FK_MEMBER_TO_TICKET_1"        FOREIGN KEY (     "MEMBER_ID2" ) REFERENCES "MEMBER"     (     "MEMBER_ID" );
ALTER TABLE "TICKET"      ADD CONSTRAINT "FK_TIME_TABLE_TO_TICKET_1"    FOREIGN KEY (     "SCRN_NO"    ) REFERENCES "TIME_TABLE" (     "SCRN_NO" );
ALTER TABLE "TIME_TABLE"  ADD CONSTRAINT "FK_MOVIE_TO_TIME_TABLE_1"     FOREIGN KEY (     "MOVIE_NO"   ) REFERENCES "MOVIE"      (     "MOVIE_NO" );
ALTER TABLE "TIME_TABLE"  ADD CONSTRAINT "FK_THEATER_TO_TIME_TABLE_1"   FOREIGN KEY (     "THEATER_NO" ) REFERENCES "THEATER"    (     "THEATER_NO" );
ALTER TABLE "MOVIE_EVAL"  ADD CONSTRAINT "FK_TICKET_TO_MOVIE_EVAL_1"    FOREIGN KEY (     "TICKET_NO"  ) REFERENCES "TICKET"     (     "TICKET_NO" );
ALTER TABLE "MOVIE_POST"  ADD CONSTRAINT "FK_TICKET_TO_MOVIE_POST_1"    FOREIGN KEY (     "TICKET_NO"  ) REFERENCES "TICKET"     (     "TICKET_NO" );