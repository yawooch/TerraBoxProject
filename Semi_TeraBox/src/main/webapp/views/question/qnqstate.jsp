                            ...
                            <ul>
                                <li>
                                    <div class="qt-qut-by" id="qt_on_by">
                                        <a href="#">
                                            <p class="qt-tit-by"><span class="qt-font-green-by">[극장/특별관]</span></p>
                                            <p class="qt-txt-by">
                                            ...
                                            <span style="font-size: 10.0pt">
                                                <span style="line-height : 107%;">
                                                    <span>
                                                        ...
                                                        <br>
                                                        <br>
                                                        기존 특전관련 잔여 수량에 대한 안내가 되었습니다만,
                                                        <br>
                                                        고객님의 많은 관심과 성원으로 지점별 현황 파악이 원활 하지 않아
                                                        <br>
                                                        20년 8월 13일부로
                                                        <br>
                                                        <strong>드림센터에서는 오리지널 티켓과 영화 특전의 지점별 수량에 관한 정보를 제공하지
                                                            않습니다.</strong>
                                                        <br>
                                                        번거로우시겠지만 고객님께서는 지점 방문 후 확인 부탁드립니다.
                                                        <br>
                                                        <br>
                                                        항상 테라박스를 이용해 주셔서 감사합니다.
                                                    </span>
                                                </span>
                                            </span>
                                        </p>
                                        ...
                                        <p class="qt-cont-by">
                                            <span style="font-size: 10.0pt;">
                                                <span style="line-height : 107%;">
                                                    ...
                                                    <br>
                                                    <span>EX) 성인 3명 + 5세 영아1명 + 48개월 미만 1명 = 입장가능</span>
                                                    <br>
                                                    <span> 성인 3명 + 48개월 미만 2명 = 입장가능</span>
                                                    <br>
                                                    <span> 성인4명 + 48개월 미만 2명 = 입장불가</span>
                                                    <br>
                                                    <span> 48개월 이상의 유아일 경우에는 인원수에 포함되며, 4인까지만 입장가능합니다.</span>
                                                </span>
                                            </span>
                                        </p>
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="qt-awn-by" id="qt_awn_by2">
                                        <p class="qt-cont-by">
                                            <span style="font-size: 10.0pt;">
                                                <span style="line-height : 107%;">
                                                    지점별 영화관의 주차공간이 마련되어 있으며,
                                                    <br>
                                                    주차 요금 및 주차장 정보 등 자세한 내용은 이용하시는 지점 선택 후
                                                    <br>
                                ...
                                <li>
                                    ...
                                    <div class="qt-awn-by" id="qt_awn_by3">
                                        <p class="qt-cont-by">
                                            <span style="font-size: 10.0pt;">
                                                <span style="line-height : 107%;">
                                                    <strong>◆ 전화로 상담하는 ARS</strong>
                                                    <br>
                                                    사용하시는 휴대폰 또는 유선전화로 ARS서비스를 받으실 수 있습니다. 상담 가능한 시간을 확인 하신 후 이용해 주세요
                                                    <br>
                                                    <strong>- 고객센터 운영시간 : 10:00~19:00</strong>
                                                    <br>
                                                    - 전국 어디서나 지역번호없이 1544-0070을 이용하시면 고객센터 및 ARS를 통하여 문의를 할 수 있습니다.
                                                    <br>
                                                    * ARS서비스의 경우 유료이며, 발신자 부담으로 통화료가 부과됩니다.
                                                    <br>
                                                    * ARS상담원 연결이 지연되는 경우 상담톡으로 문의주시면 빠르게 안내드립니다.
                                                    <br>
                                                    <br>
                                                    ◇ 상담톡 <strong><a href="#" style="color: red" ;> ▷바로가기</a></strong>
                                                    <br>
                                                    궁금한 내용을 챗봇이 바로 알려주고, 추가 문의는 상담원과 채팅으로!
                                                    <br>
                                                    전화보다 빠르고 간편하게 채팅으로 상담톡 문의가능합니다.
                                                    <br>
                                                    <br>
                                                    ◇ 1:1 문의하기 <strong><a href="#" style="color: blue" ;>
                                                            ▷바로가기</a></strong>
                                                    <br>
                                                    고객센터 및 극장별 궁금하신 사항이 있으시면 문의글로 남겨주시면 답변 드리겠습니다.
                                                    <br>
                                                </span>
                                            </span>
                                            </span>
                                ...
                                <li>
                                    ...
                                    <div class="qt-awn-by" id="qt_awn_by7">
                                        <p class="qt-cont-by">
                                            <span style="font-size: 10.0pt;">
                                                <span style="line-height : 107%;">
                                                    <span>홈페이지 및 모바일 어플 고객센터 > 분실물 문의를 통해 관람하신 지점과 상세 내용을 기재하여
                                                        접수하여주시면</span>
                                                    <br>
                                        ...
                                        <p class="qt-cont-by">
                                            <span style="font-size: 10.0pt;">
                                                <span style="line-height : 107%;">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <span>상영관 내 돌발상황 발생 및 알러지 보유 고객 등 다른 고객으로부터 불편이 접수 될 수 있어 입장이 제한되는 점
                                                        양해 부탁드립니</span>
                                                    <br>
                                                    <span>다.</span>
                                                </span>
