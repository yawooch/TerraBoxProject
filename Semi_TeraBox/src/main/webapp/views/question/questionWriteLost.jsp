           ...
           <div class="lnb-area">
               <nav id="lnb">
                   ...
                   <ul>
                       ...
                       <li class="on"><a href="${path}/question/lost"   title="분실물 문의">분실물 문의</a></li>
                   </ul>
		...
		<div class="mypage-infomation mt20">
			...
			<div class="tab-block">
				<ul>
					...
					<li><a href="${path}/question/writerentview" class="btn" title="단체관람/대관 문의내역 탭으로 이동">단체관람/대관문의</a></li>
					<li class="on"><a href="${path}/question/writeLost"  class="btn" title="분실물 문의내역 탭으로 이동">분실물 문의</a></li>
				</ul>
			</div>
			<div class="agree-box">
				<dl>
