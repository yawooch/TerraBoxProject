            ...
            <div class="qt-mainarea-by">
                ...
                <div id="qt_contents_by">
                    ...
                    <div class="board-view">
                        ...
                        <div class="info">
                            <p><span class="txt">문의사항</span></p>
                            <p><strong class="txt">강남</strong></p>
                            <p><span class="txt">010-1234-4567</span></p>
                            <p><span class="txt">kh1234@naver.com</span></p>
                            <p><span class="txt">2024.01.17 21:56:35</span></p>
                            <p><span class="txt">미답변</span></p>
                        </div>
                        <div class="cont">
                            <textarea rows="5" cols="30" readonly class="input-textarea view" style="border: none;">지갑을 잃어버렸습니다
                            </textarea>
                        </div>
                        <div class="btn-group pt40">
                            <a href="http://localhost:8080/views/question/lostItem.jsp" id="listBtn" class="button large" title="목록">목록</a>
