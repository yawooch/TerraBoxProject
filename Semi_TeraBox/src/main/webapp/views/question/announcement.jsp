                ...
                <div id="qt_contents_by">
                        ...
                        <ul>
                            <li class="qt-on-by">
                                <button type="button" class="qt-btn-by qt-tabBtn-by" id="qt-totalTab-by" data-no
                                    title="전체"><a class="qt-acolor-by" href="http://localhost:8080/views/question/announcement.jsp">전체</a></button>
                            </li>
                            <li>
                                <button type="button" class="qt-btn-by qt-tabBtn-by" id="qt-totalTab-by" data-no="88"
                                    title="테라박스 공지"><a class="qt-acolor1-by" href="http://localhost:8080/views/question/announcementTerr.jsp">테라박스 공지</a></button>
                            </li>
                            <li>
                    ...
                    <div class="qt-board-list-util-by">
                        ...
                        <p class="qt-result-count-by">
                            <strong>
                                "전체"
                                <em class="qt-font-gblue-by">3,646</em>
                                "건"
                            </strong>
                        </p>
                        <div class="qt-board-search-by">
                            <input type="text" id="qt_searchTxt_by" title="검색어를 입력해 주세요." placeholder="검색어를 입력해 주세요."
                                class="qt-input-text-by" value maxlength="15">
                            <button type="button" id="qt_searchBtn_by" class="qt-btn-search-input-by">검색</button>
                        </div>
                    </div>
                        ...
                        <table class="qt-board-list-by">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>공지</td>
                                    <th>
                                        <a href="#" class="qt-moveBtn-by" title="공지사항 상세보기"><span>[컬쳐랜드] 시스템점검 안내 (1/25)</span></a></th>
                                    <td>2024.01.15</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>테라박스</td>
                                    <td>공지</td>
                                    <th><a href="#" class="qt-moveBtn-by" title="공지사항 상세보기"><span>테라박스 개인정보 처리방침 변경 안내</span></a></th>
                                    <td>2024.01.15</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>강남</td>
                                    <td>공지</td>
                                    <th><a href="#" class="qt-moveBtn-by" title="공지사항 상세보기"><span>[강남] 7월 9일 긴급점검으로 인한 운영중단 및 취소 안내</span></a></th>
                                    <td>2024.01.17</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>상암</td>
                                    <td>공지</td>
                                    <th><a href="#" class="qt-moveBtn-by" title="공지사항 상세보기"><span>[상암월드컵경기장]23.10.31(화) 주차장 이용 안내</span></a>
                                    </th>
                                    <td>2024.01.15</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>공지</td>
                                    <th>
                                        <a href="#" class="qt-moveBtn-by" title="공지사항 상세보기"><span>메가박스 금액권 판매 종료 안내(11/30)</span></a>
                                    </th>
                                    <td>2024.01.11</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>공지</td>
                                    <th>
                                        <a href="#" class="qt-moveBtn-by" title="공지사항 상세보기"><span>[홍대] 현금없는 극장 운영안내</span></a>
                                    </th>
                                    <td>2024.01.12</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>공지</td>
                                    <th>
                                        <a href="#" class="qt-moveBtn-by" title="공지사항 상세보기"><span>[동대문] 굿모닝시티 건물 주차요금 변경 안내</span></a>
                                    </th>
                                    <td>2024.01.15</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>공지</td>
                                    <th>
                                        <a href="#" class="qt-moveBtn-by" title="공지사항 상세보기"><span>도서문화상품권 PIN 결제방식 서비스 종료 안내 (12/31)</span></a>
                                    </th>
                                    <td>2024.01.15</td>
                                </tr>
                            </tbody>
