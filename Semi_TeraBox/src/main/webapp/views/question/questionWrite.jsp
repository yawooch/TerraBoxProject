                ...
                <form name="regFrm" method="post">
                            ...
                            <table class="board-form va-m">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <input type="radio" id="aq2" name="inqMclCd" value="QD01M02" data-cd="QD_ETC_DIV_CD" checked="">
                                            <label for="aq2">고객센터문의</label>
    
                                            <input type="radio" id="aq1" name="inqMclCd" class="ml20" value="QD01M01" data-cd="QD_BRCH_DIV_CD">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="upload-image-box">
                                                ...
                                                <div id="imgList">
                                                    <p class="dw-link">
                                                        <a href="/SharedImg/2024/01/19/KnFRypUIGlG1dILWYMQeErqImz9Zwkf9.png" title="첨부파일 다운로드">츠어여 (4).png</a> <button type="button" class="btn-del" data-no="1191167" data-sn="1">첨부파일 삭제</button></p></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <!--// 2019-02-14 사진첨부 마크업 수정 -->
                                        ...
                                        <tr>
                                            <th scope="row"><label for="name">비밀번호</label> <em class="font-orange">*</em></th>
                                            <td colspan="3">
                                                <input type="text" id="nonMbInqPw" name="nonMbInqPwd" class="input-text w150px pwnew" maxlength="4" oninput="gfn_numberMaxLength(this);">
                                                <em class="fc_r ml10">* 1:1 문의에 대한 고객정보 보호를 위해 게시글의 비밀번호를 설정해주세요.</em>
                                            </td>
                                        </tr>
                        ...
                        <div class="table-wrap mt10" style="display:none;">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <select id="theater" class="small" title="지역선택" tabindex="-98">
                                        <option value="">지역선택</option>
                                            <option value="10">서울</option>
                                            <option value="30">경기</option>
                                            <option value="35">인천</option>
                                    ...
                                    <select name="brchNo" id="theater02" title="극장선택" class="small ml07" disabled="disabled" tabindex="-98">
                                        <option value="">극장선택</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <select name="lentTime" class="small ml07" title="시간선택" tabindex="-98">
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input type="text" name="inqurNm" id="lentAinqurNm" class="input-text w150px" value="" maxlength="30"></td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="lentHpNum1">연락처</label> <em class="font-orange">*</em></th>
                                <td>
                                    <input type="text" name="hpNum1" id="lentHpNum1" class="input-text w60px numType" maxlength="3" title="핸드폰번호 첫자리 입력">
                                    <span>-</span>
                                    <input type="text" name="hpNum2" class="input-text w60px numType" maxlength="4" title="핸드폰번호 중간자리 입력">
                                    <span>-</span>
                                    <input type="text" name="hpNum3" class="input-text w60px numType" maxlength="4" title="핸드폰번호 마지막자리 입력">
                                </td>
                                <th scope="row"><label for="lentRpstEmail">이메일</label> <em class="font-orange">*</em></th>
                                <td><input type="text" name="rpstEmail" id="lentRpstEmail" class="input-text" value="" maxlength="50"></td>
                            </tr>
                            <tr>
...
- 문의 내용에 개인정보(이름, 연락처, 카드번호 등)가 포함되지 않도록 유의하시기 바랍니다." class="input-textarea"></textarea>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" id="nonMbInqPw" name="nonMbInqPwd" class="input-text w150px pwnew" maxlength="4" oninput="gfn_numberMaxLength(this);">
                                    <em class="fc_r ml10">* 단체관람 및 대관문의에 대한 고객정보 보호를 위해 게시글의 비밀번호를 설정해주세요.</em>
                                </td>
                            </tr>
                            </tbody>
                            </table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <select name="brchNo" id="theater02" title="극장선택" class="small ml07" disabled="disabled">
                                            <option value="">극장선택</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="name">이름</label> <em class="font-orange">*</em></th>
                                    <td colspan="3"><input type="text" name="inqurNm" id="name" class="input-text w150px" value="" maxlength="30"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="textarea">
                                            <textarea id="textarea" name="custInqCn" rows="5" cols="30" title="내용입력" placeholder="※ 문의 내용에 개인정보(이름, 연락처, 카드번호 등)가 포함되지 않도록 유의하시기 바랍니다.
...
- 분실물 상세정보" class="input-textarea"></textarea>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="number" maxlength="4" name="lstrtclInqPwd" id="pw" class="input-text w150px pwnew" placeholder="숫자 4자리" oninput="gfn_numberMaxLength(this);">
